	...
	<div class="customizer_wrapper">
		...
		<div class="customizer_element __demos">
			<select name="demos_switcher" id="demos_switcher" data-class="demos_switcher">
				...
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/thirteen" value="thirteen"><?php esc_html_e( 'Sao Paulo', 'consulting' ); ?></option>
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/fourteen" value="fourteen"><?php esc_html_e( 'Abu Dhabi', 'consulting' ); ?></option>
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/fifteen" value="fifteen"><?php esc_html_e( 'Dublin', 'consulting' ); ?></option>
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/sixteen" value="sixteen"><?php esc_html_e( 'Tel Aviv', 'consulting' ); ?></option>
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/seventeen" value="seventeen"><?php esc_html_e( 'Dubai', 'consulting' ); ?></option>
				<option class="demo_twelve" demo-url="http://consulting.stylemixthemes.com/eighteen" value="eighteen"><?php esc_html_e( 'Tehran', 'consulting' ); ?></option>
			</select>
		</div>
		...
		<?php if( $consulting_config['layout'] == 'layout_1' ) : ?>
			...
			<div class="customizer_element">
				<select name="header_style">
					...
					<option class="header_style_5" value="<?php echo esc_url( home_url( '/?header_demo=header_style_5' ) ); ?>"><?php esc_html_e( 'Style 5', 'consulting' ); ?></option>
					...
					<option class="header_style_7" value="<?php echo esc_url( home_url( '?header_demo=header_style_7&hide_top_bar=1' ) ); ?>"><?php esc_html_e( 'Style 7', 'consulting' ); ?></option>
				</select>
			</div>
